                ...
                <div className="w-full p-4 rounded-lg border-2">
                    <div className="w-full flex justify-between items-center mb-4">
                        <div className="w-auto bg-[#3096891A] rounded-md">
                            <p className="p-1 cursor-default text-[#309689] font-normal text-sm">{job.time}</p>
                        </div>
                    ...
                    <div className="w-full text-right">
                        <a href="/job-info">
                            <button className="w-32 h-10 rounded-lg font-semibold text-sm sm:text-base bg-[#309689] text-white border-[2px] hover:bg-white hover:border-[#3EB489] hover:text-[#3EB489]">
                                Job Details
                            </button>
                        </a>
                    </div>
