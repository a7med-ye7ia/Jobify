        ...
        <footer className="bg-black text-white py-8">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 p-10">
                <div className="space-y-4">
                    <div className="flex items-center gap-2 cursor-pointer hover:text-[#3EB489]">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><a href="#" className="hover:text-[#3EB489]">About Us</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">Our Team</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">Partners</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">For Candidates</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">For Employers</a></li>
                    </ul>
                </div>
                <div>
                    <h3 className="text-lg font-semibold mb-4">Industries</h3>
                    <ul className="space-y-2">
                        <li><a href="#" className="hover:text-[#3EB489]">Telecommunications</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">Hotels & Tourism</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">Construction</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">Education</a></li>
                        <li><a href="#" className="hover:text-[#3EB489]">Financial Services</a></li>
                    </ul>
                </div>
